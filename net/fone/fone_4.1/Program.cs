...
namespace fone_4._1 {
    class Program {
        static void Main (string[] args) {
            ...
            PP pp = new PP();
            if (Console.ReadLine () == "y") pp = PP.New(Convert.ToDouble (Console.ReadLine ()), Convert.ToDouble (Console.ReadLine ()), Convert.ToDouble (Console.ReadLine ()), Convert.ToDouble (Console.ReadLine ()), Convert.ToDouble (Console.ReadLine ()));
            pp.Print();
    ...
    class PP {
        ...
        private PP (double h, double sh, double g, double x, double y) {
            this.h = h;
            this.sh = sh;
            this.g = g;
            this.x = x;
        ...
        public static PP New (double h, double sh, double g, double x, double y) {
            try {
                if (h > 0 && sh > 0 && g > 0) return new PP (h, sh, g, x, y);
